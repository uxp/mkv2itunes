require "json"
require "mkv2itunes/streams/video_stream"
require "mkv2itunes/streams/audio_stream"
require "mkv2itunes/streams/subtitle_stream"
...
module Mkv2itunes
  class VideoFile
     ...
     def initialize(file, name)
      @streams = Array.new
      file.video_streams.each {|v| @streams.push(Streams::VideoStream.new(v))}
      file.audio_streams.each {|a| @streams.push(Streams::AudioStream.new(a))}
      file.subtitle_streams.each {|s| @streams.push(Streams::SubtitleStream.new(s))}
